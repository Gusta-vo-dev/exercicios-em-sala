...
Begin
  ...
  begin
  	writeln;
  	writeln (' 0 - Fechar Dicion�rio');
  	writeln (' 1 - Inserir Palavra-Chave');
  	writeln (' 2 - Inserir Palavras no Dicion�rio');
  	writeln (' 3 - Remover Palavras do Dicion�rio');
  	writeln (' 4 - Consultar Dicion�rio');
  	writeln (' 5 - Escrever o Dicion�rio');
  	writeln;
  	repeat
  		write (' Escolha uma op��o para sua lista: ');
  	  readln ( op );
  	until ( op in [0..5] );
  	writeln;
    case op of
