Program JogoTruco;
	...
	var i: integer;
	begin
	  // L�gica da Manilha (Pr�xima carta ap�s a vira)
	  case jok.carta of
	    7:  manilha := 10; 
	    10: manilha := 11; 
	    11: manilha := 12; 
	...
	begin
	  x := 1;
		if quemCorta = true then //Defini se quem corta � o jogador ou o computador//
		begin
			writeln('          ======================================');  
		  repeat
		    write('          Sua vez de cortar o baralho(1 � 40): ');
		    readln(corte);
		...
		begin
			corte:= random(39) + 1;
			writeln('          ======================================');
			writeln ('          O computador cortou na posi��o ', corte, '!');
			writeln('          ======================================'); 
		end;
	...
	begin
	  ...
	  for i := 1 to 6 do
	  begin
	    if (i mod 2 = 1) then  //Condi��o para alternar quem come�a recebendo as cartas//
	    begin
	      maoJ[posiJ] := baral[i];
	      posiJ := posiJ + 1;
	    end
	...
	begin	
		...
		begin
			 ...
			 begin //Computador fugiu do pedido de truco//
			 		fugiu := true;
		      writeln('� � � � � O ', adversario, ' correu! Voc� levou a rodada.');
			 end
		...
		begin
		  ...
		  case opcao of
		    1: begin //Op��o para aceitar//
		         pontos_rodada:= aux_pontos;
		         writeln('� � � � � Jogo aceito! Valendo ', pontos_rodada);
		       end;
		    2: begin //Op��o para correr//
		         fugiu := true;
		         writeln('� � � � � ' ,adversario, ' correu! O Computador leva a rodada.');
		       end;
		    3: begin //Op��o para retrucar//
		         pontos_rodada:= aux_pontos;
						 aux_pontos:= aux_pontos + 3; 
						 quemTrucou:= 'J';      
		         quemPede:= 'J';
	...
	begin
	  ...
	  begin
	  	writeln;
	    writeln('          -----  VOC� CHEGOU EM M�O DE ONZE! ----');
	    writeln;
	    writeln('          Sua m�o:');
	    for i := 1 to 3 do
	    ...
	    begin
	    	writeln;
	      writeln('          Voc� recusou. O Computador ganhou 1 ponto');
	      writeln;
	      pontosC := pontosC + 1;
	      fugiu := true;
	    end;
	  ...
	  begin
	    ...
	    writeln;
	    for i := 1 to 3 do //L�gica do computador, se a m�dia for boa, ele aceita//
	...
	begin
	  ...
	  textcolor(lightblue);
		  writeln('          ==========================================');
		  writeln('          PONTUA��O GERAL: Voc� ', pontosJ, ' x ' ,pontosC, ' Computador');
		  writeln('          ==========================================');
		textcolor(lightgray);
		  writeln('          A MANILHA DA RODADA � O: ', manilha);
			writeln('          Placar da Rodada:   Voc� ', quedasJ, ' x ', quedasC, ' Computador');
	...
	begin 
	  ...
	  pontos_rodada:= 1;
	  fugiu:= false;
	  if (pontosJ = 11) or (pontosC = 11) and not( pontosC = pontosJ ) then //Entrada para caso haja m�o de onze//
	  begin
	  ...
	  begin
	    ...
	    begin
			    ...
			    for escolha := 1 to 3 do
			      ...
			      repeat
					    ...
					    begin
					      ...
					      begin
								  write('          Voc� deseja Trucar( S- Sim   N- N�o): ');
						      readln( esc_truco );
				  ...
				  begin
					  if quedasC = 0 then //Condi��es para Computador pedir truco//
			    ...
			    cartaC := maoC[escolha];
			    writeln;
			    writeln('          Voc� jogou: ', cartaJ.carta, ' de ', cartaJ.naipe);
			    writeln;
			    writeln('          Computador jogou: ', cartaC.carta, ' de ', cartaC.naipe);
					writeln;
			end
			else //Condi��o caso quem come�a seja o computador//
			begin
			    writeln('          Sua m�o:');         
			    for escolha := 1 to 3 do
			      if not usadaJ[escolha] then
		    ...
		    begin
		      writeln('          >> Empatou!');
					quedasC := quedasC + 1;
					quedasJ := quedasJ + 1;
					condEmpate:= condEmpate + 1; //Condi��o para caso empatar uma ou duas rodadas//	
		    end;
		  end;
		  fugiu:= false;
	...
	begin
	    ...
	    writeln('          ======================');
	    if pontosC >= 12 then
	    	writeln ('          VOC� PERDEU � PARTIDA!')
	    else 
	    	writeln ('          VOC� VENCEU � PARTIDA!');
	    writeln('          ======================');
	    readkey;                                         
	end;
